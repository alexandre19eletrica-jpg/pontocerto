...
- **Governanca** (`/platform-admin/governanca`): listagem de empresas com `lightweightProfilePending` (entrada leve) ate concluirem perfil e vinculo contador; livro de demos com leitura administrativa anonimizada (`platformListStandaloneLightweightCompanies`, `platformListPublicDemoAccessLedger`).
