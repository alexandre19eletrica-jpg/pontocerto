...
/// sem paginas de “orientacao” ou temas puramente informativos no gov.br.
class AccountantDeclarationsPage extends ConsumerWidget {
  ...
  static const _pfAvulsoLinks = <_OfficialRfLink>[
    _OfficialRfLink(
      ...
      subtitle: 'Entrada unica de servicos da Receita; apos o login, e-CAC completo.',
      url: ReceitaOfficialUrls.ecacLogin,
    ),
    _OfficialRfLink(
      title: 'Baixar o programa do IRPF (PGD / DIRPF)',
      subtitle: 'Central oficial de download do gerador de declaracao (receitafederal.gov.br).',
      url:
  ...
  static const _empresaCarteiraLinks = <_OfficialRfLink>[
    ...
    _OfficialRfLink(
      ...
      subtitle: 'Declaracao anual no sistema oficial (Simples Nacional / Receita).',
      url: ReceitaOfficialUrls.dasnSimei,
    ),
    _OfficialRfLink(
      title: 'Simples Nacional — PGDAS e servicos',
      subtitle: 'Apuracao, DAS, parcelamento — grupo de servicos no portal do Simples.',
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    ref.read(shellPageChromeProvider.notifier).state = ShellPageChrome(
      header: AppWorkspaceHeader(
        ...
        subtitle:
            'Acessos oficiais com acao (e-CAC, download IRPF, PGMEI, DASN, Simples, ECF). PF avulso (escritorio) e empresas na carteira — contextos separados.',
        chips: [
          AppHeaderChip('Empresa ativa: ${session.companyId}'),
        ],
      ),
    );
        ...
        child: ListView(
          children: [
            AppWorkspaceCard(
              ...
              subtitle:
                  'Troque a empresa na sua carteira antes de operar modulos da empresa. A secao de PF e conceitualmente independente do cadastro CNPJ no Ponto Certo: nao misture anotacoes de CPF com dados de CNPJ.',
              child: Column(
                ...
                children: [
                  ...
                  linksAsync.when(
                    ...
                    error: (Object? e, StackTrace? s) => const Text(
                      'Nao foi possivel ler a carteira.',
                    ),
                  ),
                ],
              ),
            ...
            AppWorkspaceCard(
              ...
              subtitle:
                  'Pessoas fisicas acompanhadas pelo escritorio, fora do cadastro-empresa no sistema. Apenas portais oficiais abaixo; cadastro de tarefas por PF evolui em modulo dedicado.',
            ...
            const AppWorkspaceCard(
              ...
              subtitle:
                  'Links levam a sistemas oficiais (dominios Receita, gov.br de download, Simples) — nao a paginas de noticia. Procuracoes e certificados seguem regras da Receita.',
