                ...
                children: [
                  ...
                  if (selectedProvider.toLowerCase().contains('focus')) ...[
                    const Align(
                      ...
                      child: Text(
                        'Token API Focus: ja preenchido pela empresa suprema. '
                        'Ninguem ve o valor aqui; fica so na infraestrutura segura da plataforma.',
            ...
            ElevatedButton(
              onPressed: () async {
                ...
                final next = _FiscalRealIntegrationSetup(
                  ...
                  apiToken: isFocus ? '' : apiTokenController.text.trim(),
                  usesPlatformFocusToken: isFocus,
